...
// ===================================================================
// *** AUTOR ***
router.get('/pagina/criar', (req, res, next) => {
...
router.get('/pagina/deletar', async  (req, res, next) => {
    try{
      const lista_autoresRecuperado = await Autor.find({}).exec();
...
// ===================================================================
// *** LIVRO ***
router.get('/pagina_livro/criar',  async (req, res, next) => {
  try {
...
router.get('/autor/detalhes/titulo/:titulo', async (req, res, next) => {
    try{
